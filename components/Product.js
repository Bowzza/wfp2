...
const Product = (props) => {
  ...
  return (
    <div className={`card ${styles.card}`}>
        <img src={props.product.img} className={`${styles.cardImgTop} card-img-top`} alt="no img" height="300" width="200" />
        <div className="card-body">
            ...
            <div className={`${styles.linkSection} d-flex justify-content-center align-items-center`}>
                ...
                {props.product.inWishlist && isAuth ? <span className={`${styles.iconAbsolute} me-3`}><i className={`bi bi-bag-check-fill ${styles.bi}`} ></i></span>
